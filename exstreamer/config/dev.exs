...
config :exstreamer, ExstreamerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "XyaDK32sK1OrrkT5waWJpKAuCSUWpzKO6GRL9sjEwWmvdTH8GX7a9h2lIN1r/U4R",
  watchers: [
...
config :exstreamer, ExstreamerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/exstreamer_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :exstreamer, dev_routes: true
